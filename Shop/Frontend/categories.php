...
<head>
    ...
    <style>
        ...
        .card-title {
            font-size: 1rem;
            font-weight: bold;
            color: white !important; /* ✅ Fix: Category name in white */
        }
    </style>
</head>
<body>
    ...
    <div class="row">
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo '<img src="data:image/jpeg;base64,' . $image . '" class="card-img-top" alt="' . $categoryName . '">';
                echo '</div>';
            ...
            echo "<div class='col-12 text-center text-danger'><h4>No categories found.</h4></div>";
        }
        ?>
    </div>
</div>
