...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $mobileNo = mysqli_real_escape_string($conn, $_POST['mobile_number']);
    $address = mysqli_real_escape_string($conn, $_POST['address']);
    $town = mysqli_real_escape_string($conn, $_POST['town']);
    $shippingAddress = mysqli_real_escape_string($conn, $_POST['shipping_address']);
    $shippingTown = mysqli_real_escape_string($conn, $_POST['shipping_town']);

    // Corrected Update Query with Backticks around special characters
                ...
                <div class="col-md-9 ">
                    <form action="edit-profile.php" method="POST">
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control rounded-5" name="firstname" value="<?php echo $user['FirstName']; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control rounded-5" name="lastname" value="<?php echo $user['LastName']; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control rounded-5 mb-2" name="address" value="<?php echo $user['P.Address']; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control rounded-5" name="town" value="<?php echo $user['P.Town']; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-8">
                                <input type="email" class="form-control rounded-5" name="email" value="<?php echo $user['Email']; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control rounded-5" name="mobile_number" value="<?php echo $user['MobileNo.']; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control rounded-5" name="shipping_address" value="<?php echo $user['S.Address']; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control rounded-5" name="shipping_town" value="<?php echo $user['S.Town']; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 d-flex mt-5">
                            ...
                            <div class="col-md-6">
                                <!-- Back Button -->
                                <a href="profile.php" class="btn btn-secondary w-75">Back</a>
                            </div>
                        </div>
                    </form>
                </div>
