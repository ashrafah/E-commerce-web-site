    ...
    <div class="login-container">
        <div class="row mt-5">
            ...
            <div class="col-0 col-md-5 p-5 d-flex align-items-center justify-content-center rounded-3 logo-color">
                <img src="#" alt="Broadband" class="logo-log h-300">
            </div>
            ...
            <div class="col-12 col-md-7 p-5">
                <h2 class="text-center register-title fw-bold">Broadband</h2>
                <form>
                    
                    <div class="my-5">
                        <label for="vehical-number" class="form-label fw-bold">Enter Your Broadband Number</label>
                    ...
                    <div class="my-5">
                        ...
                        <input type="number" class="form-control rounded-5" name="o-name" id="o-name" placeholder="Enter your email">
                    </div>
