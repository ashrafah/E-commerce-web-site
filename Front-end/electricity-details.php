    ...
    <div class="login-container">
        <div class="row mt-5">
            ...
            <div class="col-0 col-md-5 p-5 d-flex align-items-center justify-content-center rounded-3 logo-color">
                <img src="#" alt="Electricity img" class="logo-log h-300">
            </div>
            ...
            <div class="col-12 col-md-7 p-5">
                ...
                <form class=" mt-5">
                    ...
                    <div class="my-3">
                        <label for="bill-payment" class="form-label fw-bold">Enter Your Bill Payment</label>
                        <input type="text" class="form-control rounded-5" name="bil-pay" id="bill-pay" placeholder="Enter your Bill Payments">
                    </div>
                    
                    <div class="my-3">
                        <label for="customer-name" class="form-label fw-bold">Enter Customer Name</label>
                        <input type="text" class="form-control rounded-5" name="cusname" id="cusname" placeholder="Enter your Name">
                    </div>
