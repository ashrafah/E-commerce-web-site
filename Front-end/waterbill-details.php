        ...
        <div class="row mt-5">
            ...
            <div class="col-12 col-md-7 p-5">
                ...
                <form>
                    ...
                    <div class="my-3">
                        <label for="vehical-number" class="form-label fw-bold">Enter Your Bill Number</label>
                        <input type="text" class="form-control rounded-5" name="ve-num" id="ve-num" placeholder="Enter your Vehical Number">
                    </div>
                    
                    <div class="my-3">
                        <label for="email" class="form-label fw-bold">Enter Customer Name</label>
                        <input type="text" class="form-control rounded-5" name="o-name" id="o-name" placeholder="Enter your email">
                    </div>
